...
import { Download, Play, Save, AlertTriangle, CheckCircle2, Database, FileDown } from "lucide-react";
...
export const Route = createFileRoute("/_app/processar")({
  head: () => ({
    meta: [
...
function ProcessarPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-bold">Processar planilhas</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Concilie bairros da Receita Federal com a referência SISGRAN de Campo Grande-MS.
        </p>
      </div>
